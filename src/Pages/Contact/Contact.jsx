                    ...
                    <div className="flex flex-wrap -mx-4 lg:justify-between">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <p
                                    className=" text-xl leading-relaxed text-body-color dark:text-dark-6 mb-9"
                                >
                                   Contact with us to know about our services and to order food of your choice, Thank you..!
                                </p>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        Jashore Club, Opposite of Anti Corruption Commission,, Jessore, Bangladesh
                                        </p>
                                    </div>
                                </div>
                                <div className="mb-8 flex w-full max-w-[370px]">
